      ...
      <div className='p-4 pt-1 pb-0 border-2 border-solid border-t-0 bg-white text-xs gap-y-2'>
        <div className='flex my-2'>
          ...
          {/* <div className={`w-8 flex justify-center items-center text-white border-2 p-1.5 mr-2 rounded-full hover:drop-shadow-2xl`}>
            ...
            <div className={`w-8 flex justify-center items-center text-white border-2 p-1.5 mr-2 rounded-full hover:drop-shadow-2xl`}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className='fill-yellow-500'>
            ...
            <div>
              ...
              >
                ...
                <span className='text-xs font-semibold ' >{t('column.user.addTask')}</span>
              </Button>
              <Button size={"xs"} variant="white" className='border-2 border-solid	border-blue-500'>
                ...
                <span className='text-sky-500 font-extrabold '>{t('column.user.share')}</span>
              </Button>
            </div>
          </div>
        </div>
          ...
          <div >
            <Tabs>
              <Tabs.Item
                ...
                totals={20}
                render={<Item title={t('tabs.user.overview')} bgColor="bg-sky-500" number={20} ></Item>}
              />
              <Tabs.Item
                ...
                totals={20}
                render={<Item title={t('tabs.user.task')} bgColor="bg-red-500" number={20}></Item>}
              />
              <Tabs.Item
                title={t('tabs.user.discussion')}
                onTabClick={() => handleTabClick('discussion')}
                totals={20}
                render={<Item title={t('tabs.user.discussion')} bgColor="bg-amber-500	" number={20}></Item>}
              />
              <Tabs.Item 
                title={t('tabs.user.files')}
                onTabClick={() => handleTabClick('file')}
                totals={20}
                render={<Item title={t('tabs.user.files')} bgColor="bg-lime-500" number={20}></Item>}
              />
              <Tabs.Item
                title={t('tabs.user.timeline')}
                onTabClick={() => handleTabClick("timeline")}
                totals={20}
                render={<Item title={t('tabs.user.timeline')} bgColor="bg-green-500" number={20}></Item>}
              ...
              <Tabs.Item
                ...
                totals={20}
                render={<Item title={t('tabs.user.reports')} bgColor="bg-teal-500" number={20}></Item>}
              ...
              <Tabs.Item
                ...
                totals={20}
                render={<Item title={t('tabs.user.more')} bgColor="bg-purple-500" number={20}></Item>}
              />
            </Tabs>
          </div>
          <div>
