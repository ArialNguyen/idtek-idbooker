...
export default function HomePage({}: Props) {
    ...
    const [taskClicked, setTaskClicked] = useState<TaskType | undefined>(
        undefined
    )
    ...
    const onDragEnd = (event: DragEndEvent) => {
        ...
        if (active.data.current?.type !== over?.data.current?.type) {
            ...
            if (previousTask!!.status !== currentTask.status) {
                // Move Task to another Position in another Column
            } else {
                // Swap Task or Do nothing in one Column
            }
        }
        ...
        <div className="flex flex-col">
            <div className="p-4 pt-1 pb-0 border-2 border-solid border-t-0 bg-white text-xs gap-y-2">
              ...
              <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
                <rect fill="none" height="256" width="256"/><circle cx="128" cy="128" fill="none" r="60" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
                ...
                <line fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" x1="193.1" x2="207.2" y1="62.9" y2="48.8"/>
                        ...
                        <div
                            className={`w-8 flex justify-center items-center text-white border-2 p-1.5 mr-2 rounded-full hover:drop-shadow-2xl`}
                        >
                            <svg
                        ...
                        <div>
                            <Button
                                size={'xs'}
                                className="mr-2 bg-sky-600 hover:bg-sky-700 text-white"
                                onClick={() => openTaskTab('AddNew')}
                            >
                                <div
                                    className={`w-3.5 flex justify-center items-center text-white mr-2 `}
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 640 512"
                            ...
                            >
                                <div
                                    className={`w-3.5 flex justify-center items-center text-white mr-2 rounded-full hover:drop-shadow-2xl`}
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 640 512"
                ...
                <div>
                    ...
                    <div className="w-fit p-0.5 flex items-center border-2 rounded-full">
                        <div
                            className={`w-8 flex justify-center items-center text-white rounded-full hover:drop-shadow-2xl`}
                        >
                            <img
                        ...
                        <div className="h-fit m-2 text-sky-500 font-extrabold">
                            PM
                        </div>
                    </div>
                </div>
                <div className="flex justify-between items-center">
                    ...
                    <div>
                        <Button
                            ...
                            size={'xs'}
                            variant="white"
                            className="mr-3 border-2 border-solid	border-gray-200"
                        >
                            <BsViewList
                                color={`${
                                    criteria.view == 'list' ? 'blue' : 'gray'
                                }`}
                                className="w-6"
                            />
                            <span
                        ...
                        >
                            <MdOutlineViewKanban
                                color={`${
                                    criteria.view == 'kanban' ? 'blue' : 'gray'
                                }`}
                                className="w-5"
                            />
                            <span
                                className={`${
                                    criteria.view == 'kanban'
                                        ? 'text-blue-500'
                                        : 'text-slate-500'
                                }  font-semibold text-xs`}
                            >
            ...
            <AddAndUpdateTask
                key={v4()}
                action="AddNew"
                columnId={addTaskColumnClicked}
                show={taskTab == 'AddNew'}
                onCloseTab={closeTaskTab}
                handleDoneClick={(task: TaskType) => {
                    setTasks([...tasks, task])
                    closeTaskTab()
                }}
            />
...
export const TaskColumnColors = [
    ...
    },
    {
        ...
        bgTextColor: 'bg-fuchsia-100'
    },
    {
        columnId: 'InProgress',
        dotColor: 'bg-pink-500',
        textColor: 'text-pink-500',
        bgTextColor: 'bg-pink-200'
    },
    {
        columnId: 'Done',
        dotColor: 'bg-green-500',
        textColor: 'text-green-500',
        bgTextColor: 'bg-green-200'
    }
]
