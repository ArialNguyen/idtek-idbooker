...
export default function Header({ }: Props) {
    ...
    return (
        <div className='basis-4/5 h-full'>
            <div className='border-solid border-2 p-1 flex justify-center items-center'>
                <div className='w-8/12 '>
                    <div className='w-4/12 bg-white border-solid border-2 border-stone-200 rounded-lg flex justify-center items-center'>
                        <div className="w-3/12">
                            <div className='flex justify-center items-center text-white p-2 m-1 rounded-full '>
                        ...
                        <div className='w-9/12 '>
                            <input type="search" className="w-full outline-none" placeholder="Search" />
                ...
                <div className='w-4/12 flex justify-end	items-center '>
                    <div className='w-2/12 '>
                        <div className={`w-10 bg-sky-500 flex justify-center items-center text-white border-2 p-3 m-1 rounded-full hover:drop-shadow-2xl`}>
                    ...
                    <div className='w-2/12'>
                        <Dropdown
                            render={
                                <div className={`w-10 bg-slate-200 flex justify-center items-center text-white border-2 m-1 rounded-full hover:drop-shadow-2xl`}>
